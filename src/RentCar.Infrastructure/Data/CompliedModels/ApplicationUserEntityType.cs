...
namespace RentCar.Infrastructure.Data.CompliedModels
{
    internal partial class ApplicationUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            address.TypeMapping = NpgsqlJsonTypeMapping.Default.Clone(
                comparer: new ValueComparer<Address>(
                    (Address v1, Address v2) => object.Equals(v1, v2),
            ...
            var cardId = runtimeEntityType.AddProperty(
                "CardId",
                typeof(string),
                propertyInfo: typeof(ApplicationUser).GetProperty("CardId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(ApplicationUser).GetField("<CardId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 12);
            cardId.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
                ...
                providerValueComparer: new ValueComparer<string>(
                    ...
                    (string v) => v),
                mappingInfo: new RelationalTypeMappingInfo(
                    storeTypeName: "character varying(12)",
                    size: 12));
            cardId.TypeMapping = ((NpgsqlStringTypeMapping)cardId.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
        ...
        dateOfBirth.TypeMapping = NpgsqlDateOnlyTypeMapping.Default.Clone(
            ...
            providerValueComparer: new ValueComparer<DateOnly>(
                ...
                (DateOnly v) => v.GetHashCode(),
                (DateOnly v) => v));
        dateOfBirth.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
...
var licenseId = runtimeEntityType.AddProperty(
    "LicenseId",
    typeof(string),
    propertyInfo: typeof(ApplicationUser).GetProperty("LicenseId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    fieldInfo: typeof(ApplicationUser).GetField("<LicenseId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    maxLength: 12);
licenseId.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
    comparer: new ValueComparer<string>(
        (string v1, string v2) => v1 == v2,
        (string v) => v.GetHashCode(),
        (string v) => v),
    ...
    mappingInfo: new RelationalTypeMappingInfo(
        storeTypeName: "character varying(12)",
        size: 12));
licenseId.TypeMapping = ((NpgsqlStringTypeMapping)licenseId.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
licenseId.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
licenseId.AddAnnotation("Relational:ColumnName", "license_id");

var licenseType = runtimeEntityType.AddProperty(
    "LicenseType",
    typeof(LicenseType),
    propertyInfo: typeof(ApplicationUser).GetProperty("LicenseType", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    fieldInfo: typeof(ApplicationUser).GetField("<LicenseType>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
licenseType.TypeMapping = IntTypeMapping.Default.Clone(
    comparer: new ValueComparer<LicenseType>(
        (LicenseType v1, LicenseType v2) => object.Equals((object)v1, (object)v2),
        (LicenseType v) => v.GetHashCode(),
        (LicenseType v) => v),
    keyComparer: new ValueComparer<LicenseType>(
        (LicenseType v1, LicenseType v2) => object.Equals((object)v1, (object)v2),
        (LicenseType v) => v.GetHashCode(),
        (LicenseType v) => v),
    providerValueComparer: new ValueComparer<int>(
    ...
    mappingInfo: new RelationalTypeMappingInfo(
        storeTypeName: "integer"),
    converter: new ValueConverter<LicenseType, int>(
        (LicenseType value) => (int)value,
        (int value) => (LicenseType)value),
    jsonValueReaderWriter: new JsonConvertedValueReaderWriter<LicenseType, int>(
        JsonInt32ReaderWriter.Instance,
        new ValueConverter<LicenseType, int>(
            (LicenseType value) => (int)value,
            (int value) => (LicenseType)value)));
licenseType.SetSentinelFromProviderValue(0);
licenseType.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
licenseType.AddAnnotation("Relational:ColumnName", "license_type");
